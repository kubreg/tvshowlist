...
public class SerialTestData {
    ...
    public static Serial getCreated() {
        return new Serial(10, "Batman vs. Superman", "Ben Afflec, Tom Hardy", "DC Comics", 7.0, 6.5);
    }

    public static Serial getUpdated() {
        return new Serial(SERIAL1_ID, "Homeland", "Tony Kapoor, Lisa Berns", "Blah-blah-blah", 8.5, 8.0);
    }
}
